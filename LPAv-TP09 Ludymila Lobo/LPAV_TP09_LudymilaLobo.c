...
void imprime_relatorio(double tempo_gasto, unsigned long long int qtd_trocas, unsigned long long int qtd_comparacoes, int n)
{ 
...
void bubble_sort(int v[], int n, double *tempo_gasto,unsigned long long int *qtd_trocas, unsigned long long int *qtd_comparacoes) {
    int i, j, aux; 
    *qtd_trocas = 0;
    *qtd_comparacoes = 0;
    *tempo_gasto = 0;
...
void insertion_sort(int v[], int n, double *tempo_gasto,unsigned long long int *qtd_trocas, unsigned long long int *qtd_comparacoes) 
{
   *qtd_trocas = 0;
    *qtd_comparacoes = 0;
    *tempo_gasto = 0;
...
void merge_sort_0(int v[], int n,unsigned long long int *qtd_trocas, unsigned long long int *qtd_comparacoes) {
...
void merge_sort(int v[], int n, double *tempo_gasto,unsigned long long int *qtd_trocas, unsigned long long int *qtd_comparacoes)
{
	*qtd_trocas = 0;
	*qtd_comparacoes = 0;
	*tempo_gasto = 0;
...
void selection_sort(int v[], int n, double *tempo_gasto,unsigned long long int *qtd_trocas, unsigned long long int *qtd_comparacoes)
{ 
	*qtd_trocas = 0;
	*qtd_comparacoes = 0;
	*tempo_gasto = 0;
...
void quick_sort_0(int v[], int inicio, int fim,unsigned long long int *qtd_trocas, unsigned long long int *qtd_comparacoes)
{
    int r;
...
void quick_sort(int v[], int n, double *tempo_gasto,unsigned long long int *qtd_trocas, unsigned long long int *qtd_comparacoes)
{
	*qtd_trocas = 0;
	*qtd_comparacoes = 0;
	*tempo_gasto = 0;
...
void calcula_todo_relatorio_quicksort_imprime(int v[], int n)
{
	printf("** QUICK SORT\n\n");
	unsigned long long int qtd_comparacoes = 0, qtd_trocas = 0;
	int i, soma_tempo = 0, soma_trocas = 0, soma_comparacoes = 0,media_tempo = 0, media_trocas = 0,media_comparacoes = 0; 
...
void calcula_todas_ordenacoes_todos_os_tamanhos()
{
	...
	printf("\n\n");	
	calcula_todo_relatorio_quicksort_imprime(v,n);
	printf("\n\n**** PARA TAMANHO 5000\n");
	free(v);
	n = N5k;
	v = (int*) malloc(n * sizeof(int));
...
void calcula_todas_ordenacoes_todos_os_tamanhos2()
{
	int n = N1k;
	int *v;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_bubblesort_imprime(v,N1k);
	free(v);
	n = N5k;
	v = (int*) malloc(n * sizeof(int));	
	printf("\n\n");
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_bubblesort_imprime(v,N5k);
	free(v);
	n = N10k;
	v = (int*) malloc(n * sizeof(int));	
	printf("\n\n");
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_bubblesort_imprime(v,N10k);
	free(v);
	n = N20k;
	v = (int*) malloc(n * sizeof(int));	
	printf("\n\n");
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_bubblesort_imprime(v,N20k);
	printf("\n\n");
	free(v);
	n = N50k;
	v = (int*) malloc(n * sizeof(int));
	printf("** PARA VETOR DE %d\n",n);	
	calcula_todo_relatorio_bubblesort_imprime(v,N50k);
	printf("\n\n");
	printf("**********************************************\n\n");
	free(v);
	n = N1k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_selectionsort_imprime(v,N1k);
	printf("\n\n");
	free(v);
	n = N5k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_selectionsort_imprime(v,N5k);	
	printf("\n\n");
	free(v);
	n = N10k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_selectionsort_imprime(v,N10k);
	printf("\n\n");
	free(v);
	n = N20k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_selectionsort_imprime(v,N20k);
	printf("\n\n");
	free(v);
	n = N50k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_selectionsort_imprime(v,N50k);
	printf("\n\n");
	printf("**********************************************\n\n");
	free(v);
	n = N1k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_insertionsort_imprime(v,N1k);
	printf("\n\n");
	free(v);
	n = N5k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_insertionsort_imprime(v,N5k);
	printf("\n\n");
	free(v);
	n = N10k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_insertionsort_imprime(v,N10k);
	printf("\n\n");
	free(v);
	n = N20k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_insertionsort_imprime(v,N20k);
	printf("\n\n");
	free(v);
	n = N50k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_insertionsort_imprime(v,N50k);
	printf("\n\n");
	printf("**********************************************\n\n");
	free(v);
	n = N1k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_mergesort_imprime(v,N1k);
	printf("\n\n");
	free(v);
	n = N5k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_mergesort_imprime(v,N5k);
	printf("\n\n");
	free(v);
	n = N10k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_mergesort_imprime(v,N10k);
	printf("\n\n");
	free(v);
	n = N20k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_mergesort_imprime(v,N20k);
	printf("\n\n");
	free(v);
	n = N50k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_mergesort_imprime(v,N50k);
	printf("\n\n");
	printf("**********************************************\n\n");
	free(v);
	n = N1k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_quicksort_imprime(v,N1k);
	free(v);
	n = N5k;
	v = (int*) malloc(n * sizeof(int));	
	printf("\n\n");
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_quicksort_imprime(v,N5k);
	free(v);
	n = N10k;
	v = (int*) malloc(n * sizeof(int));	
	printf("\n\n");
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_quicksort_imprime(v,N10k);
	printf("\n\n");
	free(v);
	n = N20k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_quicksort_imprime(v,N20k);
	printf("\n\n");
	free(v);
	n = N50k;
	v = (int*) malloc(n * sizeof(int));	
	printf("** PARA VETOR DE %d\n",n);
	calcula_todo_relatorio_quicksort_imprime(v,N50k);
	printf("\n\n");
	printf("**********************************************\n\n");
...
int main()
{
	...
	//calcula_todas_ordenacoes_todos_os_tamanhos2();
	return 0;
}
